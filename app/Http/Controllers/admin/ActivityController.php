...
class ActivityController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $activity->save();
        return redirect()->route('activity.index')->with('successMsg','JOURNEY Successfully Saved');
    ...
    public function update(Request $request, $id)
    {
        ...
        $activity->image = $imagename;
        $activity->save();
        return redirect()->route('activity.index')->with('successMsg','JOURNEY Successfully Updated');
    }
    ...
    public function destroy($id)
    {
        ...
        $activity->delete();
        return redirect()->back()->with('successMsg','JOURNEY Successfully Deleted');
    }
