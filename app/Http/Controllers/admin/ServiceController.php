...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $service->save();
        return redirect()->route('service.index')->with('successMsg','Policy Successfully Saved');
    ...
    public function update(Request $request, $id)
    {
        ...
        $service->image = $imagename;
        $service->save();
        return redirect()->route('service.index')->with('successMsg','Policy Successfully Updated');
    }
    ...
    public function destroy($id)
    {
        ...
        $service->delete();
        return redirect()->back()->with('successMsg','Policy Successfully Deleted');
    }
