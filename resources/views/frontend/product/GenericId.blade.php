                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-9 tab-content">
                            <div class="product-details-wrapper">
                                <h2>To view {{ \App\GCategory::where('id', $lastSlug)->first()->t_category_name }}
                                    Class</h2>
                                <select onchange="window.location.href=this.value" class="form-select select-width" aria-label="Default select example">
                                    <option value="">Select None</option>
                                    @foreach(\App\GCategory::all() as $g_cat)
                                        <option value="{{ route('GenericId', $g_cat->id) }}">{{ $g_cat->t_category_name }}</option>
                                    @endforeach
                                </select>
                                ...
                                <div class="product-tabing-all-product">
                                    ...
                                    <div class="row mt-3" id="productList">
                                        ...
                                        @foreach(\App\ProductManage::where('t_cat_id',$lastSlug)->get() as $productCategory)
