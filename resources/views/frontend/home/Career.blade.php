...
<div class="row">
  <div class="col-md-10 offset-md-1">
    <ul class="job-list">
        {{-- @foreach($news as $intiatives) --}}
        @foreach(\App\Post::orderBy('sequence', 'asc')->get() as $intiatives)
          ...
          <p style="margin-left:0in; margin-right:0in">
            <span style="font-size:11pt">
              <span style="font-family:Calibri,sans-serif"> {!! $intiatives->description !!}</span>
                                ...
                                <a href="{{ route('career.details',$intiatives->slug) }}" class="btn btn-apply float-sm-right float-xs-left">
                                    View Details
                                </a>
