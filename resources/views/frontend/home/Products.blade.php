    ...
    <section class="about-sec sec-ptb pt-200">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    ...
                    <div class="sec-content mt-150 text-center">
                        <h2 class="sec-title">EXPLORE <br>HEALTHCARE PHARMACEUTICALS<br>PRODUCTS</h2>
                        <div class="blog-sidebar-search text-center">
                            <form action="{{ route('search.product') }}" method="GET">
                                <input type="text" id="product-search-input" name="query" autocomplete="off">
                                <button type="submit">
            ...
            <div class="row align-items-center tab-col-gap wow fadeInUp" data-wow-delay="500ms" data-wow-duration="1500ms">
                @php
                    $products = \App\Product::paginate(12); // Pagination directly in Blade template
                @endphp
...
{{--                    </div>--}}
 ...
 @php
       $modal= \App\Objects::where('id', 10)->first();
    @endphp
