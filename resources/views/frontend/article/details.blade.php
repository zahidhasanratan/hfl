    ...
    <section class="newsroom sec-ptb pt-200">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-lg-4 news-right-sidebar">

                    @foreach(\App\Article::orderBy('id', 'DESC')->take(10)->get() as $news)
                        <div class="blog-item blog-box-shadow wow fadeInUp mb-15" data-wow-delay="0ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;">
                            ...
                            <div class="content-box">
                                <div class="title-box">
                                    <h3>
                                        <a href="{{ route('article.details',$news->slug) }}">{{ \Illuminate\Support\Str::limit($news->title, 70, '...') }} </a>
                                    </h3>
                                    <p>{{ $news->short }}</p>
                                </div>
                            </div>
