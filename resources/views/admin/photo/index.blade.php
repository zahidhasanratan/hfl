...
@section('title','All Sister Concern')
@section('content')
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2>All Sister Concern</h2>
                        <a style="float:right" href="{{ route('photo.create') }}" class="btn btn-primary square-btn-adjust">Add Sister Concern</a>
                        <div class="row">
