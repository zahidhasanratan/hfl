...
@section('title','Add Research and Development')
@section('content')
    ...
    <div id="page-wrapper" >
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <h2>Add Research and Development</h2>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form role="form" method="post" action="{{ route('research.store') }}" enctype="multipart/form-data">
                                        @csrf
