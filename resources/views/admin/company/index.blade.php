...
@section('title','All Partner Logo')
@section('content')
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a style="float:right" href="{{ route('company.create') }}" class="btn btn-primary square-btn-adjust">Add Partner Logo</a>
                        <div class="row">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        @foreach($company as $key=>$company)
                                            <tr class="odd gradeX">
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ $company->title }}</td>
                                                <td><img src="{{ asset('uploads/company/'.$company->image) }}" class="img-thumbnail" width="100" height="100" /></td>
