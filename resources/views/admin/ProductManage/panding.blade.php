...
@section('title','All Panding Product List')
@section('content')
...
<div id="wrapper">
    ...
    <div id="page-wrapper" >
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <h2>All Panding Product List</h2>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            @foreach($procate as $key => $ca)
                                                 <span class="badge badge-success" style="background: green">{{$ca->Category['category_name']}}</span>
                                            @endforeach
                                        ...
                                        <td style="text-align: center" class="center">
                                            ...
                                            @if($socials->home_status=='1')
                                                 <a href="{{route('ProductManageActive',$socials->id)}}" disabled="" class="btn btn-success"><i class="fa fa-arrow-down">Yes</i></a>
                                            @else
                                              <a href="{{route('ProductManageDeactive',$socials->id)}}" disabled="" class="btn btn-warning"><i class="fa fa-arrow-up">No</i></a>
                                            @endif
                                          </td>


                                        {{-- <td style="text-align: center;"><a href="{{route('ProductManageEdite',$socials->id)}}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
