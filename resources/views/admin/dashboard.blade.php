            ...
            <div class="col-md-3 col-sm-6 col-xs-6">
                ...
                <span class="icon-box bg-color-red set-icon">
                    <i class="fa fa-tasks"></i>
                        ...
                        <div class="text-box" >
                            <p class="main-text">Policy</p>
                            <p class="text-muted"><a style="text-decoration:none;" href="{{ route('service.index') }}">Policy</a></p>
                        </div>
                    </div>
                </div>
                ...
                <span class="icon-box bg-color-green set-icon">
                    <i class="fa fa-tasks"></i>
                        ...
                        <div class="text-box" >
                            <p class="main-text">JOURNEY</p>
                            <p class="text-muted"><a style="text-decoration:none;" href="{{ route('activity.index') }}">JOURNEY</a></p>
                        </div>
                    </div>
                </div>
            </div>
